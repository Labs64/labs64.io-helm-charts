...
| ingressroute | object | `{"enabled":true,"entryPoints":["web","websecure"],"host":"swagger-ui.localhost","middlewareSpec":null,"routes":[]}` | IngressRoute configuration for Traefik more information can be found here: https://doc.traefik.io/traefik/routing/providers/kubernetes-crd/ |
...
| ingressroute.middlewareSpec | string | `nil` | Middleware configuration for the IngressRoute |
