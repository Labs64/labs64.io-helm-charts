...
| ingressroute | object | `{"enabled":true,"entryPoints":["web","websecure"],"host":"swagger-ui.localhost","middleware":null,"routes":[]}` | IngressRoute configuration for Traefik more information can be found here: https://doc.traefik.io/traefik/routing/providers/kubernetes-crd/ |
