...
![Version: 0.9.2](https://img.shields.io/badge/Version-0.9.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v5.33.0](https://img.shields.io/badge/AppVersion-v5.33.0-informational?style=flat-square)
...
| gateway.routes | list | `[{"path":"/swagger-ui","stripPrefix":true},{"path":"/","pathType":"Exact","redirectTo":"/swagger-ui/"}]` | Routes. Each: path, optional pathType (default PathPrefix), service{name,port}; stripPrefix strips the matched prefix; redirectTo issues a 302 to a fixed path. @schema type: array items:   type: object   additionalProperties: true @schema |
...
| networkPolicy | object | `{"enabled":false,"extraIngress":[],"gatewayNamespace":"tools","ingressControllerLabels":{},"observabilityNamespace":"monitoring"}` | NetworkPolicy: allow ingress from Traefik and same-namespace pods only (rendered by chart-libs.networkpolicy) |
