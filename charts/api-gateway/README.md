...
|-----|------|---------|-------------|
| affinity | object | `{}` |  |
| applicationYaml | object | `{"spring":{"cloud":{"gateway":{"server":{"webflux":{"routes":[]}}}},"data":{"redis":{"host":"redis-master.tools.svc.cluster.local","port":6379}},"security":{"oauth2":{"resourceserver":{"jwt":{"issuer-uri":"http://keycloak.tools.svc.cluster.local/realms/<realm-name>"}}}}},"springdoc":{"swagger-ui":{"urls":[]}}}` | Additional application properties |
| applicationYaml.spring | object | `{"cloud":{"gateway":{"server":{"webflux":{"routes":[]}}}},"data":{"redis":{"host":"redis-master.tools.svc.cluster.local","port":6379}},"security":{"oauth2":{"resourceserver":{"jwt":{"issuer-uri":"http://keycloak.tools.svc.cluster.local/realms/<realm-name>"}}}}}` | Spring configuration |
