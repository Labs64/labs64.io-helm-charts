...
| gateway.routes[1] | object | `{"path":"/v3/api-docs","port":8080,"public":true,"stripPrefix":true}` | OpenAPI docs (springdoc endpoint — NOT an OpenAPI operation, so it has no x-labs64-auth policy at the authproxy; public at the edge, prefix stripped) |
