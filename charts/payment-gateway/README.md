...
| applicationYaml.spring.data.redis.host | string | `"redis-master.tools.svc.cluster.local"` | Redis host; resolves to the bundled subchart when redis.enabled, else set your Redis host |
| applicationYaml.spring.data.redis.port | int | `6379` | Redis port; default: 6379 |
| applicationYaml.spring.datasource | object | `{"url":"jdbc:postgresql://postgresql.tools.svc.cluster.local:5432/payment_gateway"}` | PostgreSQL connection params |
| applicationYaml.spring.datasource.url | string | `"jdbc:postgresql://postgresql.tools.svc.cluster.local:5432/payment_gateway"` | JDBC URL; resolves to the bundled subchart when postgresql.enabled, else set your database URL |
