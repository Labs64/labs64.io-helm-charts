...
| applicationYaml.labs64.auditflow.url | string | `"http://labs64io-auditflow:8080"` | Direct AuditFlow service URL; standalone installs must override it when using a different release name |
